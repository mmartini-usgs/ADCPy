...
input_path = 'E:\\data\\Matanzas\\V23881\\'
output_path = 'E:\\data\\Matanzas\\V23881\\pythonls\\'
pd0File = input_path + 'raw\\11101whV23881.pd0'
attFile = 'E:\\data\\Matanzas\\glob_att1110.txt'
serial_number = '23881'
delta_t = "3600"
testing = False
do_part_one = True
...
if not testing:
    cdfFile = output_path + '11101whV.cdf'
    ncFile = output_path + '11101whV.nc'
    ensembles_to_convert = [0, -1]  # -1 is for all
else:
    # test subset
    cdfFile = output_path + '11101whVsubset.cdf'
    ncFile = output_path + '11101whVsubset.nc'
...
settings = {
    ...
    'transducer_offset_from_bottom': 2.408,  # meters
