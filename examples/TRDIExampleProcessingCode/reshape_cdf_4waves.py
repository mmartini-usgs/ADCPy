...
#from reshapeEPIC import find_boundaries
#from reshapeEPIC import generate_expected_start_times
#from reshapeEPIC import save_indexes_to_file

# making the indeces
inpath = 'E:\\data\\Sandwich\\10811_V20784\\python\\'
outpath = 'E:\\data\\Sandwich\\10811_V20784\\python\\'

contFile = '10811whV.cdf' # reprocessed file with depth dimension
nfiles = 1
burstFileRoot = '10811whVwave.cdf'
indexFile = '10811whVwaveindeces.txt'
...
allslices = reshapeEPIC.generate_expected_start_times(inpath+contFile,dim,burst_start_offset,
                                       burst_interval, burstlength, sample_rate)

# here we limit the slices for testing
#print('** reducing the number of slices')
slices = allslices # [10:110]
...
print('looking up the boundaries... this takes about a minute')
